...
public class ConnectionChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (myApp.getStatus() != MainActivity.DEBUG) {
            ...
            boolean isAutoReconnectWhenNetStatusChange = mPrefs.getBoolean(
            ...
            if (isAutoReconnectWhenNetStatusChange && myApp.getIsShouldRunning()) {
                ...
                if (netInfo != null && netInfo.isAvailable() && !netInfo.isFailover()
                        && netInfo.isConnected()
                        && netInfo.getState() == NetworkInfo.State.CONNECTED) {
                    if (null == MainService.connection
                            || MainService.connection.isAuthenticated() != true) {
