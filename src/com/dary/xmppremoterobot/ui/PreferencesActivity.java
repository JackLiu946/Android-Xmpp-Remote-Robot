...
package com.dary.xmppremoterobot.ui;
...
import com.dary.xmppremoterobot.R;
...
public class PreferencesActivity extends android.preference.PreferenceActivity implements
    ...
    private MultiSelectListPreference delSavedPreferences,
            delSwitchPreferencesBetweenDifferentNetwork;
    private CheckBoxPreference autoSwitchPreferencesBetweenDifferentNetwork;
    public static final String SAVE_PREFERENCES_PATH = Tools.getSDPath() + File.separator
            + MyApp.getContext().getResources().getString(R.string.app_name) + File.separator
            + "Save Preferences";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        saveCurrentPreferences.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                final EditText ETsavepreferences = (EditText) view
                        .findViewById(R.id.ETsavepreferences);
                new AlertDialog.Builder(PreferencesActivity.this).setTitle("Save Preferences")
                        .setView(view)
                        .setPositiveButton(android.R.string.ok, new OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                File file = new File(SAVE_PREFERENCES_PATH + File.separator
                                        + prefsFileName);
                                // 不能为Append模式
                                Tools.writeFile(file, prefs.toString(), false);

                                switchPreferences.setSummary("Current Preferences is "
                                        + prefsFileName);
                ...
                .setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        for (int i = 0; i < prefs.length; i++) {
                            ...
                            String oldValue = mPrefs.getString(
                                    switchPreferencesBetweenDifferentNetwork.getKey(), "");
                            // 替换掉|
                            writeValue = oldValue.replace(prefs[i] + "|", "").replace(prefs[i], "");
                            e.putString(switchPreferencesBetweenDifferentNetwork.getKey(),
                                    writeValue);
                            e.commit();
                        }
                        writeToSavedPreferences(switchPreferencesBetweenDifferentNetwork.getKey(),
                                writeValue);
                        setList();
                        return true;
                    }
        ...
        switchPreferencesBetweenDifferentNetwork
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {

                    public boolean onPreferenceClick(Preference preference) {
                        WifiManager wifiManager = (WifiManager) MyApp.getContext()
                        ...
                        if (wifiManager.getConfiguredNetworks() == null) {
                            Toast.makeText(PreferencesActivity.this, "Please Turn On Wifi",
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                                PreferencesActivity.this, android.R.layout.simple_list_item_1, cs1);
                        ...
                        b.setAdapter(adapter, new OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                                        ...
                                        android.R.layout.simple_list_item_1, cs2);
                                AlertDialog.Builder b = new Builder(PreferencesActivity.this);
                                b.setAdapter(adapter, new OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int whichPreferebces) {
                                        Toast.makeText(
                                                PreferencesActivity.this,
                                                "When " + cs1[whichNetwork] + " Switch To "
                                                        + cs2[whichPreferebces], Toast.LENGTH_LONG)
                                                .show();
                                        SharedPreferences mPrefs = PreferenceManager
                                                .getDefaultSharedPreferences(MyApp.getContext());
                                        Editor e = mPrefs.edit();
                                        String oldValue = mPrefs.getString(
                                                switchPreferencesBetweenDifferentNetwork.getKey(),
                                                "");
                                        String newValue = cs1[whichNetwork] + "^"
                                                + cs2[whichPreferebces];
                                        String writeValue = "";
                                        if (oldValue != "") {
                                            writeValue = oldValue + "|" + newValue;
                                            e.putString(switchPreferencesBetweenDifferentNetwork
                                                    .getKey(), writeValue);
                                        } else {
                                            writeValue = newValue;
                                            e.putString(switchPreferencesBetweenDifferentNetwork
        ...
        autoSwitchPreferencesBetweenDifferentNetwork
                .setOnPreferenceChangeListener(new OnPreferenceChangeListener() {

                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        writeToSavedPreferences(
                                autoSwitchPreferencesBetweenDifferentNetwork.getKey(),
                                newValue.toString());
                        return true;
                    }
                });
    ...
    public static boolean switchPreferences(Object newValue) {
        ...
        if (file.exists()) {
            ...
            SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(MyApp
                    .getContext());
            Editor e = mPrefs.edit();
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (switchPreferences != null && !switchPreferences.getSummary().toString().endsWith("*")) {
