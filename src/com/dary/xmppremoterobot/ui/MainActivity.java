...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                R.layout.auto_cmd_string_item, getResources().getStringArray(
        ...
        MsgHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == SHOW_MESSAGE) {
                    MsgView mv = new MsgView(MainActivity.this, msg.getData().getInt("type"), msg
                            .getData().getString("fromaddress"), msg.getData().getString("time"),
        ...
        // 如果是测试模式,则自动登录
        boolean isDebugMode = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
                "isDebugMode", false);
        if (isDebugMode) {
            Intent mainserviceIntent = new Intent();
            mainserviceIntent.setClass(MainActivity.this, MainService.class);
    ...
    public void sendMsg() {
        if (autoCompleteTextViewSendMessage.getText().toString().trim().length() != 0) {
            ...
            if (myApp.getStatus() == MainActivity.DEBUG) {
                MsgListener.handleMessage(null, autoCompleteTextViewSendMessage.getText()
                        .toString());
            } else if (myApp.getStatus() == MainActivity.LOGIN_SUCCESSFUL) {
                CmdBase.sendMessageAndUpdateView(MainService.chat, autoCompleteTextViewSendMessage
                        .getText().toString());
            }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_about:
                ...
                tv.setText(getResources().getString(R.string.author)
                        ...
                        + Tools.getAppVersionName(MainActivity.this) + "\n"
            ...
            case R.id.menu_changelog:
                Intent changelogIntent = new Intent();
                changelogIntent.setClass(MainActivity.this, ChangeLogActivity.class);
    ...
    public void clearMsg() {
        ...
        // 清空表
        DatabaseHelper dbHelper = new DatabaseHelper(MyApp.getContext(), DatabaseHelper.DATABASE,
                null, 1);
    ...
    private void setViewByStatus(int s) {
        switch (s) {
            case DEBUG:
                ...
                ArrayAdapter<String> autoDebugCmdStringAdapter = new ArrayAdapter<String>(this,
                        R.layout.auto_cmd_string_item, getResources().getStringArray(
            ...
            case LOGGING:
                ...
                // 对于Debug模式,要修改autoCompleteTextViewSendMessage的adapter
                ArrayAdapter<String> autoSendCmdStringAdapter = new ArrayAdapter<String>(this,
                        R.layout.auto_cmd_string_item, getResources().getStringArray(
                                R.array.autoSendCmdString));
    ...
    // 发送Handler,创建MsgView
    public static void sendHandlerMessageToAddMsgView(int type, String fromAddress, String message,
            long time) {
